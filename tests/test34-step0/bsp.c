...
#include <stdbool.h>             /* needed by TI drivers */
    ...
    */
    ...
    if ((tmp & BTN_SW1) != 0U) {  /* debounced SW1 state changed? */
        if ((buttons.depressed & BTN_SW1) != 0U) { /* is SW1 depressed? */
            ...
            /* post the event to the Button AO */
            OSQPost(BSP_queue_button, (void *)&buttonPressedEvt);
        }
        else { /* the button is released */
            static Event const buttonReleasedEvt = {BUTTON_RELEASED_SIG};
            /* post the event to the Button AO */
            OSQPost(BSP_queue_button, (void *)&buttonReleasedEvt);
        }
    }
}
/*..........................................................................*/
